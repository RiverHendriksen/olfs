 ...
 */
public class CovJsonDMR extends Dap4Responder {
    ...
    public CovJsonDMR(String sysPath, BesApi besApi, boolean addTypeSuffixToDownloadFilename) {
        this(sysPath, null, defaultRequestSuffix, besApi, addTypeSuffixToDownloadFilename);
    }

    public CovJsonDMR(String sysPath, String pathPrefix, BesApi besApi, boolean addTypeSuffixToDownloadFilename) {
        this(sysPath, pathPrefix, defaultRequestSuffix, besApi, addTypeSuffixToDownloadFilename);
    }

    public CovJsonDMR(String sysPath, String pathPrefix, String requestSuffixRegex, BesApi besApi, boolean addTypeSuffixToDownloadFilename) {
        super(sysPath, pathPrefix, requestSuffixRegex, besApi);
        log = org.slf4j.LoggerFactory.getLogger(this.getClass());
        /*
        * NOTE
        * Some of this needs to be changed eventually
        * -Riley
        */
        ...
        setServiceTitle("COVJSON Metadadata Response");//
        setServiceDescription("COVJSON representation of the DAP4 Dataset Metadata object.");//
    ...
    public void sendNormativeRepresentation(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        besApi.writeDap4MetadataAsCovJson(
                resourceID,
                qp,
